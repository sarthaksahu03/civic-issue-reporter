      ...
      <nav className="flex items-center gap-2 md:gap-4">
        ...
        {isAuthenticated && (
          <>
            ...
            <Link to="/faq" className="hidden md:inline px-3 py-2 rounded-md text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-primary">FAQ</Link>
